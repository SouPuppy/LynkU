...
export function GovernancePanel() {
  ...
  return <section aria-label="社区治理"><div className="mb-4 flex items-center justify-between"><p className="text-xs text-muted-foreground">最近更新的50条案件</p><Button variant="outline" size="sm" onClick={refresh}>刷新</Button></div><Card className="overflow-hidden py-0 shadow-none">
